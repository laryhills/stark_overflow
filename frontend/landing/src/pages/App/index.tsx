import { TheProblem } from "@pages/App/sections/TheProblem";
...
import { MarketPotential } from "./sections/MarketPotential";
      ...
      <FirstView>
        ...
        <Main>
          <h2 style={{ fontSize: "2rem", fontWeight: "bold" }}>
            The Revolution of Problem Solving
          </h2>
          <p style={{ fontSize: "1.2rem", color: "#ccc", margin: "20px 0" }}>
            A decentralized platform that financially rewards those who share
